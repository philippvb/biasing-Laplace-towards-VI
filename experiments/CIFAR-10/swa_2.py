...
args = default_parse([add_trainer_args, add_checkpoint_args , TorchVisionDataSet.add_model_specific_args, ClassificationModel.add_model_specific_args, WideResNet.add_model_specific_args])
args_trainer = args
args = vars(args)
...
args["lr_decay_cosine_steps"] = len(dataset.train_dataloader()) * args["swa_epoch_start"]
args["annealing_steps"] = len(dataset.train_dataloader()) * args["annealing_epochs"]
