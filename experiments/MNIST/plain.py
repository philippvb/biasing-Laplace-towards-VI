...
from src.datasets import MNISTDataloader, TorchVisionDataSet
...
args = default_parse([add_trainer_args, add_checkpoint_args,  TorchVisionDataSet.add_model_specific_args, ClassificationModel.add_model_specific_args, SmallCNN.add_model_specific_args])
args_trainer = args
args = vars(args)
